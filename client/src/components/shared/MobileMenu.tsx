...
const MobileMenu = () => {
  ...
  return (
    <div className="lg:hidden fixed gap-x-3 justify-evenly bottom-0 items-center flex flex-row h-12 shadow-top dark:shadow-top-dark w-full bg-white dark:bg-[#28282B]">
      <div
